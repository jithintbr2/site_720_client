...
ClientWorkStatusModel clientWorkStatusModelFromJson(String str) =>
    ClientWorkStatusModel.fromJson(json.decode(str));

String clientWorkStatusModelToJson(ClientWorkStatusModel data) =>
...
class ClientWorkStatusModel {
  ...
  factory ClientWorkStatusModel.fromJson(Map<String, dynamic> json) =>
      ClientWorkStatusModel(
        data: List<WorkUpdation>.from(
          json["data"].map((x) => WorkUpdation.fromJson(x)),
        ),
        status: json["status"],
