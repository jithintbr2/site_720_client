...
class GalleryScreen extends StatefulWidget {
  ...
  const GalleryScreen(this.projectId, {super.key});
...
class _GalleryScreenState extends State<GalleryScreen> {
  ...
  Future<void> getData() async {
    ...
    final hasNetwork = connectivityResult.contains(ConnectivityResult.mobile) ||
    ...
    try {
      final data = await HttpService.getGallery(
        token,
        widget.projectId,
      );
